...
A comprehensive performance comparison and a detailed evaluation of the trade-offs between \ac{FFI} and Socket-based communication are provided in Section~\ref{sec:comparison} of Chapter~\ref{chap:results}.
