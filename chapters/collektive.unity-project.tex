...
The integration is designed as a modular bridge between Unity and Collektive, facilitating the bidirectional flow of information as illustrated in diagram \ref{fig:bridge_architecture}. The bridge architecture is decomposed into three distinct functional components: the \textit{Unity Parser}, \textit{Collektive Parser} and \textit{Core Bridge}.
...
With the package-based strategy established, the internal architecture is divided into specialized layers to handle the translation and execution of aggregate logic.
